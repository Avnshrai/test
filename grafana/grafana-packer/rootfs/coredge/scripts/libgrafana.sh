...
if [[ -f /opt/coredge/scripts/libmysqlclient.sh ]]; then
    . /opt/coredge/scripts/libmysqlclient.sh
elif [[ -f /opt/coredge/scripts/libmysql.sh ]]; then
    . /opt/coredge/scripts/libmysql.sh
elif [[ -f /opt/coredge/scripts/libmariadb.sh ]]; then
    . /opt/coredge/scripts/libmariadb.sh
fi
