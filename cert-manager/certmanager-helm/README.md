...
# Cert-manager packaged by Coredge

cert-manager is a Kubernetes add-on to automate the management and issuance of TLS certificates from various issuing sources.

[Overview of cert-manager](https://cert-manager.io/docs/)
...
```console
helm dependency build <certmanager-chart-name>
helm package <certmanager-chart-name>
...
| `controller.image.repository`                            | Controller image repository                                                                                | `coredgeio/cert-manager-beta` |
| `controller.image.tag`                                   | Controller image tag (immutable tags are recommended)                                                      |      `""`              |
...
| `controller.acmesolver.image.repository`                 | Controller image repository                                                                                | `coredgeio/cert-manager_acme-beta`   |
| `controller.acmesolver.image.tag`                        | Controller image tag (immutable tags are recommended)                                                      | `""`                   | 
...
| `webhook.image.repository`                            | Webhook image repository                                                                                | `coredgeio/cert-manager_webhook-beta` |
| `webhook.image.tag`                                   | Webhook image tag (immutable tags are recommended)                                                      | `""`                           |
...
| `cainjector.image.repository`                            | CAInjector image repository                                                                                | `coredgeio/cert-manager_cainjector-beta`  |
| `cainjector.image.tag`                                   | CAInjector image tag (immutable tags are recommended)                                                      | `""`                  |
