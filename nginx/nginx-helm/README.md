...
# NGINX Open Source packaged by coredge
...
| `image.repository`   | NGINX image repository                                                                                | `coredge/nginx`       |
...
| `cloneStaticSiteFromGit.image.repository`           | Git image repository                                                                                | `coredge/git`         |
...
| `metrics.image.repository`                 | NGINX Prometheus exporter image repository                                                                                                | `coredge/nginx-exporter` |
...
```console
helm install my-release -f values.yaml nginx
```
