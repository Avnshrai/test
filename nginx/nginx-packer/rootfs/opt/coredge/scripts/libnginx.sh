...
ensure_nginx_app_configuration_exists() {
    ...
    export document_root="${COREDGE_ROOT_DIR}/${app}"
...
absolute_redirect off;"
    ...
    local template_dir="${COREDGE_ROOT_DIR}/scripts/nginx/coredge-templates"
...
absolute_redirect off;"
    ...
    local template_dir="${COREDGE_ROOT_DIR}/scripts/nginx/coredge-templates"
    local prefix_file="${NGINX_CONF_DIR}/coredge/${app}.conf"
...
nginx_generate_sample_certs() {
    local certs_dir="${NGINX_CONF_DIR}/coredge/certs"
