...
# Paths
export NGINX_BASE_DIR="${COREDGE_ROOT_DIR}/nginx"
export NGINX_VOLUME_DIR="${COREDGE_VOLUME_DIR}/nginx"
...
export PATH="${NGINX_SBIN_DIR}:${COREDGE_ROOT_DIR}/common/bin:${PATH}"
