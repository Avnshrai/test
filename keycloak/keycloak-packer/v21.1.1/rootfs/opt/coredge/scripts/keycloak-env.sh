...
# Paths
export COREDGE_VOLUME_DIR="/coredge"
export JAVA_HOME="/opt/coredge/java"
export KEYCLOAK_BASE_DIR="/opt/coredge/keycloak"
...
export WILDFLY_BASE_DIR="/opt/coredge/wildfly"
export KEYCLOAK_VOLUME_DIR="/coredge/keycloak"
...
export KEYCLOAK_ADMIN_PASSWORD="${KEYCLOAK_ADMIN_PASSWORD:-coredge}"
...
export KEYCLOAK_DATABASE_USER="${KEYCLOAK_DATABASE_USER:-ce_keycloak}"
KEYCLOAK_DATABASE_NAME="${KEYCLOAK_DATABASE_NAME:-"${DB_DATABASE:-}"}"
export KEYCLOAK_DATABASE_NAME="${KEYCLOAK_DATABASE_NAME:-coredge_keycloak}"
