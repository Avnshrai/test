...
export COREDGE_ROOT_DIR="/opt/coredge"
export COREDGE_VOLUME_DIR="/coredge"

# Logging configuration
export MODULE="${MODULE:-jenkins}"
export COREDGE_DEBUG="${COREDGE_DEBUG:-false}"
...
# Paths
export JENKINS_BASE_DIR="${COREDGE_ROOT_DIR}/jenkins"
...
export JENKINS_TEMPLATES_DIR="${COREDGE_ROOT_DIR}/scripts/jenkins/coredge-templates"

# Jenkins persistence configuration
export JENKINS_VOLUME_DIR="${COREDGE_VOLUME_DIR}/jenkins"
...
export JENKINS_KEYSTORE_PASSWORD="${JENKINS_KEYSTORE_PASSWORD:-coredge}"
export JENKINS_OPTS="${JENKINS_OPTS:-}"

# Jenkins credentials
export JENKINS_USERNAME="${JENKINS_USERNAME:-user}" # only used during the first initialization
export JENKINS_PASSWORD="${JENKINS_PASSWORD:-coredge}" # only used during the first initialization
...
# Java configuration
export JAVA_HOME="${JAVA_HOME:-${COREDGE_ROOT_DIR}/java}"
