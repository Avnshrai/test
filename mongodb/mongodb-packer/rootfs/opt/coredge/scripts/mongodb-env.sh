...
# Paths
export PATH="$COREDGE_ROOT_DIR/mongodb/bin:$COREDGE_ROOT_DIR/common/bin:$PATH"
export MONGODB_VOLUME_DIR="$COREDGE_VOLUME_DIR/mongodb"
export MONGODB_BASE_DIR="$COREDGE_ROOT_DIR/mongodb"
